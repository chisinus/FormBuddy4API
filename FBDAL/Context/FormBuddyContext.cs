...
namespace FBDAL.Context
{
    public partial class FormBuddyContext : DbContext
    {
        public FormBuddyContext()
        {
        }

        public FormBuddyContext(DbContextOptions<FormBuddyContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<TblDictContactType> TblDictContactTypes { get; set; } = null!;
        public virtual DbSet<TblDictControlType> TblDictControlTypes { get; set; } = null!;
        public virtual DbSet<TblDictFaqtype> TblDictFaqtypes { get; set; } = null!;
        ...
        public virtual DbSet<TblUserLocation> TblUserLocations { get; set; } = null!;
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                IConfigurationRoot configuration = new ConfigurationBuilder()
                                       ...
                                       .Build();
                optionsBuilder.UseSqlServer(configuration.GetConnectionString("FBSQLConnectionString"));
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TblDictContactType>(entity =>
            {
                entity.HasKey(e => e.ContactTypeId);

                entity.ToTable("tblDict_ContactType");
            ...
            modelBuilder.Entity<TblDictFaqtype>(entity =>
            {
                entity.HasKey(e => e.FaqtypeId);

                entity.ToTable("tblDict_FAQType");
            ...
            modelBuilder.Entity<TblInvitation>(entity =>
            {
                ...
                entity.Property(e => e.InviteeEmails)
                    .HasMaxLength(100)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<TblSysConfig>(entity =>
            {
                ...
                entity.Property(e => e.TechSupportEmailAddress)
                    .HasMaxLength(100)
                    .IsUnicode(false);
            });
            ...
            modelBuilder.Entity<TblUserLocation>(entity =>
            {
                ...
                entity.ToTable("tblUser_Location");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.TblUserLocations)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
